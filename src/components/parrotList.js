...
import { View, FlatList, Button, Image, Alert, TouchableOpacity, Text } from 'react-native';
		...
		<View style={styles.pageBody}>
			...
			<View style={{ flex: 0.005 }}>
				{userType !== 'admin' && (
					...
					>
						<Image source={require('../images/mapViewIconFinal.png')} style={styles.mapViewIcon} />
					</TouchableOpacity>
				)}
			</View>
		</View>
